...
import UserSideLayout from "./UserSideLayout";
import karaokiAnimation from "../../public/lottieAnimations/karaoki.json";
import TopArtistSwipper from "../components/TopArtistSwipper";
  ...
  return (
    <UserSideLayout>
      ...
      <div className="flex flex-col w-full">
        ...
        >
          <Box
            className="w-[90vw] h-[90vh] lg:w-[45rem] lg:h-[92vh] rounded-[2rem] p-[2rem]"
            sx={{
              ...style,
            }}
          >
