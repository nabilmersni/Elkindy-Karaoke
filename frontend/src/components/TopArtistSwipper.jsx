            ...
            <div className="flex flex-col justify-center items-center cursor-grab">
              <div className="rounded-[2rem] w-[9rem] h-[9rem] md:w-[11rem] md:h-[11rem] shadow-sm">
                <img
                  ...
                  src={topArtist?.attributes?.artwork.url.replace(
                    "{w}x{h}",
                    "500x500"
                  )}
                  alt="artist image"
              ...
              <p className="text-[1.1rem] text-primary font-bold mt-4 text-center">
                {/* {topArtist?.attributes.artistName.split("&")[0].split(",")[0]} */}
                {topArtist?.attributes.albumName.split("- Single")[0]}
              </p>
              <span className="text-[0.9rem] font-semibold text-[#494c51]">
                {topArtist?.attributes.artistName.split("&")[0].split(",")[0]}
              </span>
            </div>
          </SwiperSlide>
